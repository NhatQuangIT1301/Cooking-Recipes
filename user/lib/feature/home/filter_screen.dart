...
class _FilterScreenState extends State<FilterScreen> {
  ...
  static const List<String> _ingredientOptions = [
    'Chicken',
    'Beef',
    'Pork',
    'Fish',
  ...
  static const List<String> _exclusionOptions = [
    'Nuts',
    'Dairy',
    'Shellfish',
    'Soy',
          ...
          children: [
            ...
            _buildChipGroup(
              ...
              (isSelected, option) {
                setState(() {
                  isSelected
                      ? _selectedExclusions.add(option)
                      : _selectedExclusions.remove(option);
                });
              },
            ),
